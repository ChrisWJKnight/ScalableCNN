...
Table 1 – Windows pip install TensorFlow
Linux Terminal
$ pip install tensorflow
$ pip install matplotlib
Table 2 – Linux pip install TensorFlow
...
Windows CMD:
/CNNtensorflowCKnight:> CNNtensorflowCKnight.py
Table 3 – Launch CNN Windows CMD
Linux Terminal
/CNNtensorflowCKnight $ python3 CNNtensorflowCKnight.py
Table 4 – Launch CNN Linux Terminal
